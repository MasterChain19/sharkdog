...
copyBtn.addEventListener("click", () => {
    ...
    document.getElementById("eggnomics-address").select();
    document.execCommand("copy");

    document.activeElement.blur();

    copyMsg.classList.add("eggnomics__main-tag-msg_active");
    setTimeout(() => {
        copyMsg.classList.remove("eggnomics__main-tag-msg_active");
    }, 3000);
});
